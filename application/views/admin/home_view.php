		...
		<ul class="list-group ">
			...
			<li class="list-group-item">
				...
				<div class="pull-right">
					<a data-toggle="modal" data-id=<?php echo site_url("admin/remove_user/$user->id"); ?> data-toggle="modal" title="Add this item" class="open-ConfirmDialog x_user" data-target=".bs-example-modal-sm" href="#addBookDialog">
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">ยืนยันการลบผู้ใช้ </div>
