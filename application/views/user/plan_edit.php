...
<div class="container">
	<div class=" well well-white">
		<div class="container">
			<font color="#0000FF" size="6">แก้ไขแผน</font>
			<div>
				<?php
				$attributes = array('class' => 'form-inline');
				echo form_open('user/update_plan/' . $plan[0]["id"], $attributes);
				?>
				<div class="col-sm-6">
		...
		<div ng-init='myStep=<?php echo $this -> session -> flashdata("myStep"); ?>; sourceTable=<?php echo $this -> session -> flashdata("sourceTable"); ?>; destinationTable=<?php echo $this -> session -> flashdata("destinationTable"); ?>; new_costs=<?php echo $this -> session -> flashdata("costOfPlan"); ?>;'>
			<?php elseif($plan) : ?>
			<div ng-init='myStep=1; sourceTable=<?php echo $plan[0]["plan_source"]; ?>; destinationTable=<?php echo $plan[0]["plan_destination"]; ?>; new_costs=<?php echo $plan[0]["plan_cost"]; ?>;'>
				<?php else : ?>
